...
const timeline = [
  ...
  //   time: "Summer 2024",
  //   desc: "Built internal dashboard reducing incident MTTR by 35%. Migrated legacy REST endpoints to GraphQL. Improved test coverage from 54% to 81%.",
  //   tags: ["React", "GraphQL", "Go"],
  //   nodeColor: "#60a5fa",
  //   orgColor: "#60a5fa",
